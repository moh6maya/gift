...
let countDown = new Date(`${config.anniversarydate} 00:00:00`).getTime();
x = setInterval(function() {
  ...
  let w = (c.width = window.innerWidth),
    ...
    opts = {
      ...
      charSize: 30,        // Font size of each character in the string
      charSpacing: 35,     // Space between each character
      lineHeight: 40 ,     // Height between lines of text
  ...
  if (distance > 0) {
    ...
    function openBox() {
      ...
      stepClass(step);
      if (step === 3) {
          // Optional: Handle any actions you want at step 3
      }
      if (step === 4) {
          return;
      }
  ...
  function showfireworks() {
    ...
    setTimeout(() => {
        ...
        link.innerHTML = 'TOUCH ME MESOFET';      
